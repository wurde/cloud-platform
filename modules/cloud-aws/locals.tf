locals {
  ...
  workers_group_defaults_defaults = {
    ...
    #TODO subnets                           = var.subnets                 # A list of subnets to place the worker nodes in. i.e. ["subnet-123", "subnet-456", "subnet-789"]
    ...
    platform                          = "linux"                     # Platform of workers. "linux" never "windows".
